...
const config = {
  ...
  moduleNameMapper: {
    ...
    '^# (.+)$': '<rootDir>/$1',
    '^#bfe (.+)$': '<rootDir>/packages/bfe/$1',
    '^#babel-plugin-metadata-accumulator (.+)$':
      '<rootDir>/packages/babel-plugin-metadata-accumulator/$1',
    '^#cli-utils (.+)$': '<rootDir>/packages/cli-utils/$1',
    '^#debug (.+)$': '<rootDir>/packages/debug/$1',
    '^#project-utils (.+)$': '<rootDir>/packages/project-utils/$1',
    '^#rejoinder (.+)$': '<rootDir>/packages/rejoinder/$1',
    '^#run (.+)$': '<rootDir>/packages/run/$1'
  },
