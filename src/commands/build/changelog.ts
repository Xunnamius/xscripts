...
Use --import-section-file to add a custom release section to the changelog. The file must contain a single custom release section generated by @-xun/changelog. This is useful when, for instance, semantic-release generates a new release section that we want to include in our final changelog file.`
    ),
