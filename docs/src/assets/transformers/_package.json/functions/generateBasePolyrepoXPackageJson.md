...
> **generateBasePolyrepoXPackageJson**(...`__namedParameters`): `object`
...
[src/assets/transformers/\_package.json.ts:117](https://github.com/Xunnamius/xscripts/blob/3a8e3952522a9aa3e84a1990f6fcb2207da32534/src/assets/transformers/_package.json.ts#L117)
