...
> **runNoRejectOnBadExit**(...`__namedParameters`): `Promise`\<`object`\>
...
> **stdio**: `MapResultStdio`\<readonly [`StdinOptionCommon`\<`false`, `false`\>, `StdoutStderrOptionCommon`\<`false`, `false`\>, `StdoutStderrOptionCommon`\<`false`, `false`\>, `StdioExtraOptionCommon`\<`false`\>] \| readonly [`undefined`, `undefined`, `undefined`] \| readonly [`"pipe"`, `"pipe"`, `"pipe"`] \| readonly [`"inherit"`, `"inherit"`, `"inherit"`] \| readonly [`"ignore"`, `"ignore"`, `"ignore"`] \| readonly [`"overlapped"`, `"overlapped"`, `"overlapped"`], [`RunOptions`](../type-aliases/RunOptions.md)\>
...
[lib/run/index.ts:81](https://github.com/Xunnamius/xscripts/blob/4fd96d6123f1ac889c89848efd750e2454f43e43/lib/run/index.ts#L81)
