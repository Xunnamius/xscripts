...
- **eslint.config:** update @typescript-eslint/unbound-method linting config ([f6515ea][10])
- **release:** take advantage of new `--only-patch-changelog` flag ([01375f7][11])
- **tsconfig:** exclude test/ dir from "lint" command limited scope, include dotfiles under lib ([df6116b][12])
- Update source aliases to latest ([8d71521][13])
- **vscode:** take advantage of new `--run-to-completion` flag ([d9b4b80][14])
- **vscode:** update example with latest best practices ([64b7309][15])

## [1.17.0][16] (2024-07-23)

### ✨ Features

- **@-xun/cli-utils:** add `interpolateTemplate` ([63354c7][17])
- **@-xun/cli-utils:** add `softAssert` and `hardAssert` ([369d969][18])

### ⚙️ Build System

- **eslint.config:** update to eslint flat config (eslint.config.mjs) ([609fca8][19])
- **husky:** update husky scripts ([e55a88e][20])
- **package:** add semver; force install alpha versions of typescript-eslint et al ([b56fd66][21])
- **package:** update exports, dependencies, and scripts ([323579d][22])
- **tsconfig:** ensure files from root dot folders are picked up by linters ([8609db7][23])
- Update to eslint\@9; begin transition to eslint.config.js flat ([52763c5][24])

## [1.16.0][25] (2024-07-14)

### ✨ Features

- **@-xun/run:** make intermediate result available ([1153f42][26])
- **@-xun/run:** update to work with latest execa ([12ee54a][27])
- **@black-flag/extensions:** allow check property to accept an array of check functions ([0543cff][28])
- **src:** implement "lint" command ([346b4ac][29])

### 🪄 Fixes

- **package:** include missing listr2 dependency ([f42f4ab][30])
- **src:** ensure "build distributables" copies non-compiled files into ./dist ([e596e5b][31])
- **src:** ensure "lint" command linter subprocesses don't write to stdout or hang after error ([d96ae1d][32])
- **src:** ensure proper checks with various arguments ([c9e254a][33])

### ⚙️ Build System

- **babel:** allow babel to parse syntax attributes and ignore dynamic import transforms ([060ef01][34])
- **husky:** update lint script to use latest name ([ea6aaff][35])
- **package:** add final npm scripts ([eb5631b][36])
- **package:** replace typescript babel preset dependency with syntax plugin ([b72401a][37])
- **package:** update lint scripts to use xscripts ([7c1e7f1][38])
- **tsconfig:** remove packages glob from includes ([d3301ca][39])

---

### 🏗️ Patch [1.16.1][40] (2024-07-14)

#### 🪄 Fixes

- **src:** place --copy-files argument in proper order in babel build sub-command ([8f1d25d][41])

## [1.15.0][42] (2024-07-07)
...
- _"build(prettierignore): no longer ignore CHANGELOG.md when formatting"_ ([ddd9192][75])
...
- **lib:** move `AsStrictExecutionContext` into @black-flag/extensions ([ae46adf][89])
- **src:** add --prepend-shebang, Next.js support to "build distributables" command ([6575d49][90])
- **src:** improve capabilities of "format" command ([7d33dfe][91])

### 🪄 Fixes

- **src:** actually implement --skip-docs functionality in "format" command ([d535b78][92])
- **src:** restrict root/sub-root check to certain commands ([1b65f46][93])

---

### 🏗️ Patch [1.10.1][94] (2024-06-29)

#### 🪄 Fixes

- **src:** ensure --files is respected by prettier in "format" command ([483f036][95])
...
- **lib:** commit @black-flag/extensions\@1.0.0 and @-xun/cli-utils\@1.0.0 ([c775d6e][115])
...
## [1.4.0][125] (2024-06-01)

### ✨ Features

- **src:** implement "dev" script ([4eeba00][126])

### ⚙️ Build System

- **package:** use real path to devdep version of xscripts ([99d5786][127])

---

### 🏗️ Patch [1.4.1][128] (2024-06-02)

#### 🪄 Fixes

- **src:** pass arbitrary args to downstream executable ([4b94a07][129])

#### ⚙️ Build System

- **package:** update "start" script to ensure arbitrary args are not erroneously parsed ([a8ddaa5][130])
...
[10]: https://github.com/Xunnamius/xscripts/commit/f6515ea793a72cfd42cb6d3f74675b2ae3a9b2e1
[11]: https://github.com/Xunnamius/xscripts/commit/01375f77f74bfaf0b38de5bdd30d162461aa6106
[12]: https://github.com/Xunnamius/xscripts/commit/df6116b1c5ad4c0f7c3152cc254d943a7b9e67e7
[13]: https://github.com/Xunnamius/xscripts/commit/8d7152112e4927f566e048c6b0be7dfce4a6c430
[14]: https://github.com/Xunnamius/xscripts/commit/d9b4b80db15e6104a2a3ab7325996a08a350ea6d
[15]: https://github.com/Xunnamius/xscripts/commit/64b7309fcb28c1214f1edcc8319960c1c94f72b0
[16]: https://github.com/Xunnamius/xscripts/compare/v1.16.1...v1.17.0
[17]: https://github.com/Xunnamius/xscripts/commit/63354c710f8cfe21d274c7083eecd28da66c57c9
[18]: https://github.com/Xunnamius/xscripts/commit/369d9690614b09b8a2a9efe4321a2786a60e2f20
[19]: https://github.com/Xunnamius/xscripts/commit/609fca8cde508ecdb6c74ff8d1884821afdd5eb3
[20]: https://github.com/Xunnamius/xscripts/commit/e55a88e728a9c4ccbd38648e85328ab563add014
[21]: https://github.com/Xunnamius/xscripts/commit/b56fd666cfcccbc7d941df7afb6fcfc74ec0ae56
[22]: https://github.com/Xunnamius/xscripts/commit/323579d026f46d2d0f70aa44440543eecbc7b4e2
[23]: https://github.com/Xunnamius/xscripts/commit/8609db712c80439ee26966b638b8d6a9cb6e0d59
[24]: https://github.com/Xunnamius/xscripts/commit/52763c5b795e9ee0485e9a20a4cb5264eae0ef3c
[25]: https://github.com/Xunnamius/xscripts/compare/v1.15.0...v1.16.0
[26]: https://github.com/Xunnamius/xscripts/commit/1153f424ae97b339f1ae345269663ddc5d3458d7
[27]: https://github.com/Xunnamius/xscripts/commit/12ee54a21f0004eb568763507540157371aa06be
[28]: https://github.com/Xunnamius/xscripts/commit/0543cff5d6e50a688365bf314837b54342106327
[29]: https://github.com/Xunnamius/xscripts/commit/346b4ac5d27ea045cd037c4987401786f7fa572b
[30]: https://github.com/Xunnamius/xscripts/commit/f42f4ab7c83a05fed253475de7bf2df4ce53d48f
